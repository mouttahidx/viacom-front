...
export default function ViaCrm({ params: { locale } }: { params: { locale: string } }) {
  ...
  return (
    <div>
      {/* hero - enhanced with overlay gradient */}
      <div className="bg-facebook-hero bg-center bg-no-repeat bg-cover">
        <div className="bg-gradient-to-r from-secondary/80 to-secondary/70 h-full pt-24 pb-24 lg:py-44 flex flex-col items-center justify-center">
          ...
          <ButtonClient
            ...
            variant="filled"
            size="lg"
            classes="!bg-primary hover:!bg-opacity-90 mt-8 shadow-lg"
            text={t("btn_contact")}
          />
        </div>
      </div>
      ...
      <section className="w-full flex flex-col xl:container my-40 gap-y-20 px-2 bg-gray-50 py-20 rounded-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white p-8 rounded-lg shadow-md border-t-4 border-primary hover:shadow-xl transition-shadow duration-300">
      ...
      {/* pricing section - improved cards with images */}
      <section id="forfaits" className="w-full flex flex-col xl:container my-40 gap-y-20 px-2 bg-gray-50 py-20 rounded-3xl">
        <div className="text-center flex flex-col items-center">
          <h2 className="text-3xl capitalize font-semibold text-gray-600">
            {t("crm_pricing_title")}
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md flex flex-col hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="w-full h-48 rounded-lg overflow-hidden mb-6">
              <Image
                unoptimized
                src={"/img/crm-essential-plan.webp"}
                alt="Essential Plan"
                width={300}
                height={200}
          ...
          <div className="bg-white p-8 rounded-lg shadow-md border-2 border-primary flex flex-col relative hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <div className="w-full h-48 rounded-lg overflow-hidden mb-6">
              <Image
                unoptimized
                src={"/img/crm-business-plan.webp"}
                alt="Business Plan"
                width={300}
                height={200}
                className="w-full h-full object-cover"
          ...
          <div className="bg-white p-8 rounded-lg shadow-md flex flex-col hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="w-full h-48 rounded-lg overflow-hidden mb-6">
              <Image
                unoptimized
                src={"/img/crm-enterprise-plan.webp"}
                alt="Enterprise Plan"
                width={300}
                height={200}
                className="w-full h-full object-cover"
      ...
      {/* testimonials - improved with avatar images */}
            ...
            <div key={index} className="bg-white p-6 rounded-lg shadow-md border-l-4 border-primary hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-4">
                <div className="w-16 h-16 rounded-full overflow-hidden mr-4 border-2 border-primary">
                  <Image
                    unoptimized
                    src={`/img/testimonial-${index + 1}.webp`}
      ...
      {/* FAQ */}
      <section className="2xl:container flex flex-col items-center mt-10 pb-24 px-4">
      ...
      <section className="2xl:container flex flex-col items-center mb-16 py-16 px-4">
        <h2 className="text-gray-600 text-3xl font-medium">
          {t("other_title")}
        </h2>
        <div className="w-[50px] bg-primary h-1 mx-auto mt-3 mb-10"></div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2 transform flex flex-col items-center">
              <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mb-4">
                <svg className="w-8 h-8 text-red-600" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M22.18 10.382c-.39-.038-.779-.059-1.174-.059-3.32 0-6.397 1.172-8.799 3.131l3.443 2.994c1.573-1.396 3.631-2.156 5.683-2.156.475 0 .941.046 1.396.117v-3.492c0-.186-.196-.515-.549-.535zM8.753 18.588c1.516 1.352 3.608 2.213 5.911 2.213.526 0 1.036-.043 1.535-.11v-3.521a6.75 6.75 0 0 1-1.397.118c-2.037 0-3.915-.781-5.387-2.07l-3.396 2.982c2.383 1.97 5.453 3.152 8.783 3.152.399 0 .791-.021 1.187-.053.52-.053.906-.468.906-.978v-11.31l-6.629-5.773c-.304-.25-.752-.246-1.050 0l-10.203 8.95c-.406.355-.444.973-.08 1.37l1.53 1.676c.363.397.978.435 1.382.077l8.324-7.29z" />
                </svg>
              </div>
              <span className="text-xl text-secondary font-semibold group-hover:text-primary transition-colors duration-300">
                {t("other_google")}
      ...
      {/* CTA - moved to bottom with improved design */}
