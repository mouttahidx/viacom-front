    ...
    <div className="overflow-hidden">
      ...
      <section className="w-full flex flex-col max-w-7xl mx-auto px-4 my-20 md:my-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {Array.from({ length: 3 }).map((_, index) => (
            <div
              key={index}
              className="bg-white p-6 rounded-lg shadow-md border-l-4 border-primary hover:shadow-xl transition-all duration-300"
            >
              <div className="flex items-center mb-4">
      ...
      <section className="w-full bg-gray-50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Removed the max-w-5xl mx-auto div wrapper */}
      ...
      <section className="w-full py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Removed the max-w-5xl mx-auto constraint from this grid */}
